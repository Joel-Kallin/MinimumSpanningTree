...
struct Tuple find_minimal_edge(int from, int size, int g[size][size], int visited[size]){
...
*/
int unvisited(int size, int array[size]){
...
*/
void printArray(int size, int g[]){
  for (int i = 0; i < size; i++){
...
int prim(int size, int g[size][size])
{
  int totalCost = 0;
...
int main()
{
	...
	Planet planets[num_planets]; // create list of all planets
	int g[num_planets][num_planets]; // create cost matrix for teleporters between planets
